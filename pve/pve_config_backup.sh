...
###############################################################################
# Script Name: pve_config_backup.sh
# Description: Backs up critical Proxmox configuration files to external HDD
# Purpose: Disaster recovery configuration backup
#
...
# Configuration for external HDD backup
BACKUP_ROOT="/mnt/external-hdd/node-backups"
RETENTION_DAYS=90
COMPRESS_ALGO="zstd"
