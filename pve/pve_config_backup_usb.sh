...
###############################################################################
# Script Name: pve_config_backup_usb.sh
# Description: Backs up critical Proxmox configuration files to USB device
# Purpose: Portable disaster recovery configuration backup
#
...
# Configuration for USB backup
BACKUP_ROOT="/mnt/external-ssd/node-backups"
RETENTION_DAYS=60
COMPRESS_ALGO="zstd"
